...
using Nwpie.Foundation.Location.Endpoint.App_Start;
using Nwpie.Foundation.Location.SDK.Extensions;
using Nwpie.Foundation.Location.ServiceCore.GetLocation.GetApiLocation.Services;
...
namespace Nwpie.Foundation.Location.Endpoint
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.RegisterAssemblyTypes<IDomainService>(ServiceLifetime.Transient,
                typeof(LocGetApiLocation_DomainService).Assembly,
        ...
        public void Configure(IApplicationBuilder app, IHostApplicationLifetime lifetime)
        {
            ...
            app.UseSdk(LocationServiceConfig.ServiceName,
                lifetime
            );
            //).RegisterEvent(LocationConst.LocationEventName,
            //    LocationEventHandler.OnConsumed
            //); // dont need to subscribe myself messages
        }
    }
}
