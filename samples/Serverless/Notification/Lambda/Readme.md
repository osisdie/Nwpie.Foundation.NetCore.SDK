...
Execute unit tests
```
    cd "Nwpie.Foundation.Notification.Lambda.Service/test/Nwpie.Foundation.Notification.Lambda.Service.Tests"
    dotnet test
```

Deploy application
```
    cd "Nwpie.Foundation.Notification.Lambda.Service/src/Nwpie.Foundation.Notification.Lambda.Service"
