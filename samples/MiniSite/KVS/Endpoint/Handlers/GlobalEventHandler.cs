    ...
    public static class GlobalEventHandler
    {
        ...
        public static void AddGlobalResponseFilters(this AppHostBase host)
        {
            host.GlobalResponseFiltersAsync.Add(async (req, res, responseDto) =>
            {
                ...
                var data = responseDto?.GetType()?.GetProperty(nameof(ContractResponseBase.ExtendedDictionary))?.GetValue(responseDto, null);
        ...
        //private static readonly int CacheDurationSecs = 5 * 60;
    }
}
