...
#================================================================
# - Document
#   - Development   https://api-dev.kevinw.net/es/metadata
#   - Production    https://api.kevinw.net/es/metadata
# - HealthCheck
#   - Development   https://api-dev.kevinw.net/es/health
#   - Production    https://api.kevinw.net/es/health
...
docker build \
  ...
  -f docker/ESProxy/Endpoint/Dockerfile
