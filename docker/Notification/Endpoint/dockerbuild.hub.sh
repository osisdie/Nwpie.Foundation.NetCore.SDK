...
#================================================================
# - Document
#   - Development   https://api-dev.kevinw.net/hub/metadata
#   - Production    https://api.kevinw.net/hub/metadata
# - HealthCheck
#   - Development   https://api-dev.kevinw.net/hub/health
#   - Production    https://api.kevinw.net/hub/health
...
docker build \
  ...
  -f docker/Notification/Endpoint/Dockerfile
