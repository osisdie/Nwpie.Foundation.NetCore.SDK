...
#================================================================
# - Document
#   - Development   https://api-dev.kevinw.net/loc/metadata
#   - Production    https://api.kevinw.net/loc/metadata
# - HealthCheck
#   - Development   https://api-dev.kevinw.net/loc/health
#   - Production    https://api.kevinw.net/loc/health
...
docker build \
  ...
  -f docker/Location/Endpoint/Dockerfile
