...
#================================================================
# - Document
#   - Development   https://api-dev.kevinw.net/storage/metadata
#   - Production    https://api.kevinw.net/storage/metadata
# - HealthCheck
#   - Development   https://api-dev.kevinw.net/storage/health
#   - Production    https://api.kevinw.net/storage/health
...
docker build \
  ...
  -f docker/storage/Endpoint/Dockerfile
